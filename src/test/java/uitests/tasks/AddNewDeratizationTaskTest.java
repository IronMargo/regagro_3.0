...
public class AddNewDeratizationTaskTest {
    ...
    static void setUpAll() {
        ...
        task = taskFactory.createTask("Дератизация", userVet, 2, 2);
    ...
    @Tag("REGRESS")
    @Order(1)
    @DisplayName("RAT-2489 Создание задания по дератизации")
    @Test
    void addNewDeratizationTask() {
        SidebarSteps sidebarSteps = new SidebarSteps();
        tasksListSteps = sidebarSteps.getTasksListPage();
        editTaskSteps = tasksListSteps.addNewTask(task);
...
//                "Объект, указанный при создании задания, не совпадает");
    ...
    @Tag("REGRESS")
    @Order(2)
    @DisplayName("RAT-2498 Отправка задания по дератизации")
    @Test
    void sendNewDeratizationTask() {
...
//        Assertions.assertTrue(taskCardPage.isCorrectServiceAreaDisplayed(task),
...
//                "Объект, указанный при создании задания, не совпадает c данными в Карточке задания");
    ...
    @Tag("REGRESS")
    @Order(3)
    @DisplayName("RAT-2445 Получение задания по дератизации")
    @Test
    void getNewDeratizationTask() {
    ...
    @Tag("REGRESS")
    @Order(4)
    @DisplayName("RAT-2446 Просмотр карточки задания по дератизации")
    @Test
    void viewNewDeratizationTask() {
...
//                "Объект, указанный при создании задания, не совпадает c данными в Карточке задания");
    ...
    @Tag("REGRESS")
    @Order(5)
    @DisplayName("RAT-2456 Принятие задания по дератизации")
    @Test
    void applyNewDeratizationTask() {
