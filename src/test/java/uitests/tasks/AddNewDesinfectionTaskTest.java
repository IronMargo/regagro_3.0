...
public class AddNewDesinfectionTaskTest {
    ...
    static void setUpAll() {
        ...
        task = taskFactory.createTask("Дезинфекция", userVet, 2, 2);
    ...
    @Tag("REGRESS")
    @Order(1)
    @DisplayName("RAT-2489 Создание задания по дезинфекции")
    @Test
    void addNewDezinfectionTask() {
...
//                "Объект, указанный при создании задания, не совпадает");
    ...
    @Tag("REGRESS")
    @Order(2)
    @DisplayName("RAT-2498 Отправка задания по дезинфекции")
    @Test
    void sendNewDezinfectionTask() {
...
//                "Объект, указанный при создании задания, не совпадает c данными в Карточке задания");
    ...
    @Tag("REGRESS")
    @Order(3)
    @DisplayName("RAT-2445 Получение задания по дезинфекции")
    @Test
    void getNewDezinfectionTask() {
    ...
    @Tag("REGRESS")
    @Order(4)
    @DisplayName("RAT-2446 Просмотр карточки задания по дезинфекции")
    @Test
    void viewNewDezinfectionTask() {
...
//                "Объект, указанный при создании задания, не совпадает c данными в Карточке задания");
    ...
    @Tag("REGRESS")
    @Order(5)
    @DisplayName("RAT-2456 Принятие задания по дезинфекции")
    @Test
    void applyNewDezinfectionTask() {
