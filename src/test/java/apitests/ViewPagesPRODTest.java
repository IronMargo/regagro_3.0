...
public class ViewPagesPRODTest {
    ...
    @Tag("API_TEST")
    @Tag("PROD")
    @ParameterizedTest(name = "name = {index} - {0} - {2}")
    @CsvFileSource(resources = "/endpoints/ajaxEndpointsPROD.csv")
    ...
    @Tag("PROD")
    @ParameterizedTest(name = "name = {index} - {0} - {2}")
    @CsvFileSource(resources = "/endpoints/endpointsPROD.csv")
